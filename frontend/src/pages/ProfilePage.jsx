...
import { USER, PAST_BOOKINGS } from "../data";
      ...
      <div className="profile-layout">
        <div className="profile-card">
          ...
          {!editing ? (
            <>
              <h2>{form.name}</h2>
              <p className="profile-member-since">Member since {form.memberSince}</p>
        ...
        <div className="profile-stats">
          <div className="stat-card">
            <span className="stat-number">{PAST_BOOKINGS.length + 1}</span>
            <span className="stat-label">Total bookings</span>
          </div>
          <div className="stat-card">
            <span className="stat-number">
              {PAST_BOOKINGS.filter((b) => b.status === "completed").length}
            </span>
            <span className="stat-label">Shows attended</span>
          </div>
          <div className="stat-card">
            <span className="stat-number">{USER.memberSince.split(" ")[1]}</span>
